...
const TodoContainer = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center gap-5 shadow-2xl backdrop-blur-2xl p-4 border border-opacity-50 rounded-2xl min-w-96 max-w-[80vw] min-h-96 text-center">
      <h1 className="font-bold text-white text-3xl">To Do - React App</h1>
      <div className="flex justify-between items-center w-full">
        <input
          type="text"
          placeholder="Enter To Do item..."
          className="bg-slate-800 bg-opacity-30 hover:shadow-xl ml-4 p-3 pl-5 rounded-full outline-none w-full text-white transition-all ease-in-out caret-color-200 placeholder-neutral-200"
          ref={inputVal}
          onKeyUp={(e) => handleEnter(e)}
        />
        <button
          className="bg-slate-800 bg-opacity-30 hover:shadow-xl m-2 p-3 rounded-full text-white text-xl hover:scale-105 active:scale-95 transition-all ease-in-out cursor-pointer"
